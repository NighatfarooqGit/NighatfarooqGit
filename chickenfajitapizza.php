...
<main>
    <section>
      <div class="table">
        <table>
          <tr>
            <td>
              <img src="chickenfajita.jpg"> 
            </td>
            <td>
              <p><b>Chicken Fajita Pizza<br>From PKR 2500 </b><br>
    ...
    An Authentic Taste of Fajita Marinated Chicken Onion and Bell Peppers.<br>
        <br>Chicken<br>
        Cheese and Special Cheese Sauce<br>
        Vegetables with mix of Sauces<br>
    </p>
  </main><hr>
  <footer class="foot">
  <div style="display: flex; align-items: center; justify-content: space-between;">
    ...
    <p style="margin: 150px;"><strong> We Guarantee Fast Delivery </strong><br>
      ...
      <br>9:30 AM TO 6:00 PM<br>
      (MONDAY TO SATURDAY)<br>
      (+92) 423 5765510<br>
      <br><strong>Bridals: </strong><br>
      <br>(+92) 309  5559933<br>
      <br><b>For Studio Appointments:</b><br>
      <br>(+92) 309 5559944<br>
      <br><b>For Pret and Unstitch:</b><br>
      <br>Call/WhatsApp: (+92) 348 1112234<br>
      Email: wecare@republicwomenswear.com</p>
  </div>
