  ...
  <section style="background-color: aliceblue;">
    <div class="dresses">
        <div class="row">
            ...
            <figure>
                <a href="chickenfajitapizza.php"><img src="chickenfajita.jpg" alt="Chicken Fajita Pizza"></a>
                <figcaption>
                    <a href="chickenfajitapizza.php">Chicken Fajita Pizza<br> PKR 2500 </a>
                </figcaption>
            </figure>
        </div>
        <div class="row">
            <figure>
                <a href="chickentikkapizza.php"><img src="chickentikka.jpg" alt="Chicken Tikka Pizza "></a>
                <figcaption>
                    <a href="chickentikkapizza.php">Chicken Tikka Pizza<br>PKR 2000</a>
                </figcaption>
            </figure>
            <figure>
                <a href="pasta1.php"><img src="pasta1.jpg" alt="Extra Cheesy Pasta"></a>
                <figcaption>
                    <a href="pasta1.php">Extra Cheesy Pasta <br> PKR 2600 </a>
                </figcaption>
            </figure>
            <figure>
                <a href="pasta2.php"><img src="pasta2.jpg" alt="Chicken Pasta"></a>
                <figcaption>
                    <a href="pasta2.php">Chicken Pasta<br> PKR 1800 </a>
                </figcaption>
            </figure>
            <figure>
                <a href="crowncrustpizza.php"><img src="crowncrust.jpg" alt="Crown Crust Pizza"></a>
                <figcaption>
                    <a href="crowncrustpizza.php">Crown Crust Pizza<br> PKR 1500 </a>
                </figcaption>
            </figure>
        </div>
        <div class="row">
        <figure>
                <a href="bansupreme.php"><img src="bu1.png" alt="Bazinga Supreme"></a>
                <figcaption>
                    <a href="bansupreme.php">Bazinga Supreme"<br> PKR 590</a>
                </figcaption>
            </figure>
            <figure>
                <a href="reggyburger.php"><img src="bu2.png" alt="Reggy Burger"></a>
                <figcaption>
                    <a href="reggyburger.php">Reggy Burger<br> PKR 890 </a>
                </figcaption>
            </figure>
            <figure>
                <a href="bazsimple.php"><img src="bu3.png" alt="Bazinga Burgerl"></a>
                <figcaption>
                    <a href="bazsimple.php">Bazinga Burger <br>  PKR 790 </a>
                </figcaption>
            </figure>
